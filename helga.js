...
stod = `${sender}`
       ...
       ownerJid = "6282138919347@s.whatsapp.net"
				stst = stst.status == 401 ? '' : stst.status
menunya = `   『 Bot Info 』
*࿊⃟〽️* _Creator : @${dtod.split('@')[0]}_
*࿊⃟〽️* _Battery : ${baterai.battery}_
*࿊⃟〽️* _Mode : ${publik ? 'Public' : 'Self'}_
*࿊⃟〽️* _Total Hit : ${cmhit.length}_
*࿊⃟〽️* _Prefix : ${multi ? 'Multi Prefix' : 'No Prefix'}_
*࿊⃟〽️* _Nama Bot : ${NamaBot}_
*࿊⃟〽️* _Nama Owner : ${NamaOwner}_
*࿊⃟〽️* _Nomor Owner : @${otod.split('@')[0]}_
*࿊⃟〽️* _Auto Composing : ${settings.autocomposing}_
*࿊⃟〽️* _Auto Recording : ${settings.autorecording}_
